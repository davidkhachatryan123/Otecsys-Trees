...
[MemoryDiagnoser]
[KeepBenchmarkFiles]
public class SQLClosureTableAPIBenchmark
{
  ...
  public void Setup()
  {
    ...
    _client.BaseAddress = new Uri(config["API_URLS:ClosureTableBased"]!);
  }

  [Benchmark]
  [ArgumentsSource(nameof(Data))]
  public async Task<bool> HasAccessAsync(int nodeId, int parentId)
  {
